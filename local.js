const exp_text =  {
    ...
    'instructions_p2' : {
        'hun' : 'A teszt egy gyakorló résszel indul, ahol 85%-os pontossággal kell teljesítened, hogy kitölthesd a tesztet. Amennyiben nem éred el a 85%-ot, a gyakorló blokk mindaddig újraindul, amíg ez a pontossági szint nem valósul meg. A gyakorló blokk után 6 darab teszt blokk következik, minden teszt blokk után tarthatsz egy kis pihenőt. A demográfiai kérdőív után rögtön a gyakorló blokk kezdődik, állj készen!',
        'eng' : 'The test starts with a practice part where you have to pass with 85% accuracy to proceed. If you do not reach 85%, the practice block will restart until this level of accuracy is achieved. After the practice block, 6 test blocks follow, after each test block you can take a short break. After the demographic form, the practice block starts immediately, get ready!'
    },
    'instructions_p3' : {
